...
func (k *Knight) Update(args ...any) error {
	...
	if ebiten.IsKeyPressed(ebiten.KeyRight) {
		if isInsideTilemapBoundary(x+speed, y, tilemapWidthInPixels, tilemapHeightInPixels, w, h) {
			k.SetPos(x+speed, y)
		}
		...
		if isInsideTilemapBoundary(x, y-speed, tilemapWidthInPixels, tilemapHeightInPixels, w, h) {
			k.SetPos(x, y-speed)
		}
